...
SECRET_KEY = 'django-insecure-+i*_*0!4mp2p$8=x--n(5@wg#2lc%#irg*r8uo88)&chs)3cal'
...
SIMPLE_JWT = {
    #when this hour runout, your website going to ask user to login again 
